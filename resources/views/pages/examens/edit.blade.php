...
@section('content')
    ...
    {{ Form::model($examen, array('route' => array('examens.update', $examen->id),
                    'method' => 'put', 'id' => 'examen_form')) }}
    <div class="uk-grid">
    ...
    <div class="md-fab-wrapper md-fab-speed-dial-horizontal fab-save" data-fab-hover>
        <div class="md-fab-wrapper-small">
            {!! Html::decode(link_to_route('examens.index', '<i class="material-icons">&#xe166;</i></a>', null,
                    array('class' => 'md-fab md-fab-small md-fab-default', 'title' => 'Annuler'))) !!}
            <a class="md-fab md-fab-small md-fab-danger" href="{{ route('examens.delete', [$examen->id]) }}"
