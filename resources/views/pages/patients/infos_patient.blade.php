    ...
    <div class="uk-margin-top">
        ...
        <div class="uk-grid" data-uk-grid-margin>
            <div class="uk-width-medium-1-2">
                <label for="user_edit_uname_control">Prénom *</label>
                {{ Form::text('prenom', old('prenom'),array('id' => 'user_edit_uname_control','required','class'=>'capitalized md-input'.($errors->has('prenom') ? ' md-input-danger' : ''))) }}
                {!! $errors->first('prenom', '<span style="color:#dd4b39 !important"><i class="uk-icon-times-circle-o uk-text-danger"></i> :message</span>') !!}
            </div>
            <div class="uk-width-medium-1-2">
                {{ Form::label('nom', 'Nom *') }}
                {{ Form::text('nom', old('nom'),array('id' => 'user_edit_position_control','required','class'=>'capitalized md-input'.($errors->has('nom') ? ' md-input-danger' : ''))) }}
        ...
        <div class="uk-grid" data-uk-grid-margin>
            <div class="uk-width-medium-1-1">
                ...
                {{ Form::textarea('adresse', old('adresse'),array('rows'=>'3', 'class'=>'capitalized md-input'.($errors->has('adresse') ? ' md-input-danger' : ''))) }}
