...
@section('content')
    ...
    {{ Form::model($patient, array('route' => array('patients.update', $patient), 'method' => 'put')) }}
                    ...
                    <div class="user_heading_content">
                        @if(request()->has('c_id'))
                            <a style="float: right;"
                               ...
                               href="{{ route('consultations.edit', [request()->c_id, 'statut' => 'ENC']) }}">
                        ...
                        @endif
                        <h2 class="heading_b"><span class="uk-text-truncate" id="user_edit_uname">{{ $patient->prenom ?? 'Prénom' }}</span>
                            <span class="sub-heading" id="user_edit_position">{{ $patient->nom ?? 'Nom' }}</span>
                        </h2>
                    </div>
                    <div class="md-fab-wrapper">
                        <div class="md-fab md-fab-toolbar md-fab-small md-fab-accent">
                            ...
                            <div class="md-fab-toolbar-actions">
                                ...
                                <a href="{{ route('patients.delete', [$patient]) }}" data-remote="false"
                                   data-confirm="Êtes-vous sûr de vouloir supprimer cet enregistrement ?"
                                   data-uk-tooltip="{cls:'uk-tooltip-small',pos:'bottom'}" title="Supprimer">
                                    <i class="material-icons md-color-white">&#xe872;</i>
                                </a>
